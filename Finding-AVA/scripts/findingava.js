...
var generateWelcomePage = function(){
    ...
    var txtAda = document.createElement('a-text');
    txtAda.setAttribute('value', 'AVA');
    txtAda.setAttribute('color', 'orange');
    txtAda.setAttribute('width', '4');
    txtAda.setAttribute('font', 'dejavu');
    txtAda.setAttribute('position', '0.1 3 0');
    ...
    welcomePage.appendChild(txtAda);
...
var removeWelcomePage = function(){
    var wp = document.getElementById('welcome_page');
    scn.removeChild(wp);
};
